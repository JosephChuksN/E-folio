...
function Appbar(){
 ...
 return(
     <div className="flex h-20 fixed mt-20 lg:mt-0 w-full lg:w-[80%] lg:translate-y-0 bg-black z-20 -translate-y-20 text-gray-100 text-2xl items-center justify-between lg:justify-end border-b border-slate-400">
