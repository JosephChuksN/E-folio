...
return(
    ...
    <div className={` transition-all bg-gray-900 border-slate-50/20 border-r duration-500 ease-in-out z-40 ${isSidebarOpen ? "translate-x-0" : "-translate-x-72 "} lg:w-[20%] w-72 fixed lg:translate-x-0 lg:border-r border-slate-400 mt-0 `}>
