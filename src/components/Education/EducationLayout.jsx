...
return (
<>
<div className="flex justify-between text-gray-900 dark:text-gray-50   p-3 bg-gray-100 blend-darken shadow-md  dark:bg-[#1e293b] border-2 border-slate-400/10 rounded-md hover:shadow-lg ">
