...
<div className='lg:pt-6 pt-36'>
  ...
  <button
        className="bg-[#222222] dark:bg-[#1a73e8] hover:bg-[#222222]/90 absolute lg:right-80 lg:top-56 top-60 right-2  text-white active:bg-blue-800 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        type="button"
...
<div className='mt-24 lg:mt-0 text-gray-100 lg:w-3/4'>{
    educationDetails.map(data => {
      ...
      {showModal ? (
        <>
<div className="bg-white/60 dark:bg-black/60  justify-center items-center text-gray-900 dark:text-gray-100 flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
