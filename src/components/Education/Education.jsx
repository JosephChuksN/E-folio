...
<button
        className="bg-[#222222] dark:bg-[#1a73e8] hover:bg-[#222222]/90 lg:absolute right-80 top-24 translate-y-20 translate-x-72 lg:translate-x-0 lg:translate-y-0 text-white active:bg-blue-800 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        type="button"
