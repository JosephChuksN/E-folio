...
<div onClick={(e)=> e.stopPropagation()} className="relative w-full lg:w-3/4 mb-36  lg:mx-auto mx-2 z-50 shadow-lg shadow-black/60 bg-gray-100  dark:bg-[#0c0f11] rounded-md  max-w-2xl">
              {/*content*/}
