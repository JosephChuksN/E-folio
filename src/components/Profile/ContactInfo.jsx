...
<div  onClick={() => setShow(false)}  className="bg-black/60 text-gray-900 dark:text-gray-50  transition-all ease-in-out duration-500 items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">

<div onClick={(e)=> e.stopPropagation()} className="relative w-full lg:w-3/4 mb-36  lg:mx-auto mx-2 z-50 shadow-lg shadow-black/60 bg-gray-100 dark:bg-[#1e293b] rounded-md  max-w-2xl">
              {/*content*/}
