...
return(
    <>
      <>
          <div
            className="lg:pt-14 pt-14 justify-center items-center text-gray-900 dark:text-gray-100 flex overflow-x-hidden overflow-y-auto fixed inset-0  outline-none focus:outline-none"
          >
