...
return(
    <>
      <>
          ...
          >
            <div className="relative w-full lg:w-3/4 my-6 lg:mx-auto mx-2 shadow-xl shadow-black/60 dark:shadow-black/90 bg-gray-100 lg:dark:bg-[#0c0f11] dark:bg-black  rounded-md max-w-3xl">
              {/*content*/}
